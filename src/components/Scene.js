...
class Scene extends Phaser.Scene {
    ...
    create() {
        ...
        //inicializa el cursos para poder utilizarlo (creo que se dice asi xd)
        ...
        //rebote/colicion con las plataformas
    ...
    /**funcion para cuando el player choque con las bombas*/
    hitBomb (player, bomb)
{
    this.physics.pause();
